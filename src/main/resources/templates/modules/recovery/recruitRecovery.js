    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#recruitTable').bootstrapTable({
                url: '/recruit/manager/recruit/recoveryData',         //请求后台的URL（*）
                method: 'post',                      //请求方式（*）
                //类型json
                dataType: "json",
...
function del() {
    ...
    if (ids == null || ids == '') {
        ...
        $.ajax({
            url: "/recruit/manager/recruit/deleteByPhysics?ids=" + ids,    //请求的url地址
...
function recoveryData(id) {
    rc.post("/recruit/manager/recruit/recovery",{"id":id})
}

function deleteData(id) {
    rc.post("/recruit/manager/recruit/deleteByPhysics?ids="+id)
}